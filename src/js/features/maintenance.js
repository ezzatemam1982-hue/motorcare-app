        ...
        function renderHistoryList() {
            ...
            if (!car || !car.history || !car.history.length) {
                cont.innerHTML = `<div class="p-6 text-center text-xs text-slate-400">${isEn ? 'No maintenance logs found yet.' : 'لا توجد بيانات مسجلة بعد'}</div>`;
                return;
            }
