...
files_to_sync = [
    ...
    ('js/features/serviceCenters.js', 'src/js/features/serviceCenters.js'),
    ('js/features/serviceCenters.js', 'dist/js/features/serviceCenters.js'),
    ('service_centers.js', 'src/service_centers.js'),
    ('service_centers.js', 'dist/service_centers.js'),
    ('service_centers.json', 'src/service_centers.json'),
    ('service_centers.json', 'dist/service_centers.json'),
