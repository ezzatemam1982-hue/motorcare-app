...
* **الاختبارات:**
  - اجتياز اختبار `scratch/test_reset_and_relogin.cjs` بنسبة 100% (دخول تلقائي فوري بعد OTP + تسجيل خروج + رفض كلمة المرور الخاطئة + نجاح الدخول بكلمة المرور الجديدة بنسبة 100%).
