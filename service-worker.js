// MotorCare Service Worker v1.4.1
// يوفر الدعم الكامل للعمل دون اتصال (Offline Mode) وتحديثات فورية للتطبيق عبر الهواء (OTA)

const CACHE_NAME = 'motorcare-cache-v1.4.1';
